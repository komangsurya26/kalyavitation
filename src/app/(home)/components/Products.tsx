  ...
  return (
    <div className="py-10 px-4 md:px-10">
      <Tabs defaultValue="premium" className="flex items-center justify-center">
        <TabsList className="rounded-none md:w-sm">
          <TabsTrigger
            value="premium"
            className="text-xs rounded-none font-light uppercase tracking-[0.24em]"
          >
            Premium
          </TabsTrigger>
          <TabsTrigger
        ...
        {["premium", "adat", "klasik", "modern"].map((category) => (
          <TabsContent key={category} value={category} className="w-full mt-10 font-light">
              ...
              {TEMPLATES[category as keyof typeof TEMPLATES]?.map((product) => (
                <div key={product.id} className="flex flex-col gap-5">
                  ...
                  <div className="flex flex-col gap-1">
                    <h1 className="text-xs uppercase tracking-[0.24em]">
                      {product.name}
                    </h1>
                  ...
                  <div className="flex gap-2 overflow-x-auto hide-scrollbar uppercase">
                    <Link
                      ...
                      className="text-xs sm:text-sm py-1 px-4 flex items-center justify-center border border-neutral-800"
                    >
                      Review
                    </Link>
                    <a
                      href="https://wa.me/6287782057548"
                      className="text-xs sm:text-sm py-1 px-4 flex items-center justify-center bg-neutral-800 text-white"
                    >
                      Gunakan
                    </a>
                  </div>
